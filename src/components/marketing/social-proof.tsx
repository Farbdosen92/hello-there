        ...
        <section className="py-20 bg-black border-t border-white/5">
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                    {logos.map((logo, idx) => (
                        <span key={idx} className="text-xl md:text-2xl font-bold font-mono text-zinc-600 hover:text-white transition-colors cursor-default">
                            {logo}
                        </span>
                    ))}
                </div>
                ...
                >
                    ...
                    <cite className="block mt-6 not-italic text-zinc-400">
                        <span className="text-white font-semibold">Max Mustermann</span> — CEO @ Example GmbH
                    </cite>
                </motion.div>
            </div>
        </section>
