        ...
        <section id="history" className="py-32 bg-black relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center mb-24">
                    <span className="px-3 py-1 rounded-full bg-zinc-800 text-zinc-400 border border-white/10 text-xs font-mono mb-6 inline-block tracking-widest uppercase">
                        Unsere Reise
                    </span>
                    <h2 className="text-4xl md:text-6xl font-bold text-white mb-6">Von Schülern zu <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Pionieren.</span></h2>
                ...
                <div className="relative max-w-5xl mx-auto">
                    {/* Central Line */}
                    <div className="absolute left-[19px] md:left-1/2 top-0 bottom-0 w-1 bg-zinc-900 rounded-full overflow-hidden">
                        <motion.div
                            initial={{ height: 0 }}
                    ...
                    <div className="space-y-24">
                        {steps.map((step, i) => (
                            ...
                            >
                                ...
                                {/* Center Node */}
                                <div className="absolute left-0 md:left-1/2 w-10 h-10 -ml-5 bg-black border-4 border-zinc-900 rounded-full z-20 flex items-center justify-center shadow-xl group">
                                ...
                                <div className="flex-1 pl-12 md:pl-0">
                                    <div className={`relative p-8 rounded-3xl bg-zinc-900/40 border border-white/5 backdrop-blur-sm hover:bg-zinc-900/60 hover:border-blue-500/20 transition-all duration-500 group ${i % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                                        ...
                                        <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-blue-200 transition-colors">{step.title}</h3>
                                        <div className="text-lg font-medium text-zinc-400 mb-4">{step.subtitle}</div>
